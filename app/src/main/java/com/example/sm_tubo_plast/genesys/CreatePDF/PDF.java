...
public class PDF {
                                 ...
                                 int tipo_de_envio) throws FileNotFoundException
    {
        ...
        table2.addCell(new Cell().add(new Paragraph(dataCabecera.getText_area()).setTextAlignment(TextAlignment.CENTER).setFontSize(6.2f)));
        ...
        else if (tipo_de_envio == ENVIO_A_INTERNO)
        {
            ...
            //TABLE ITEMS ----- 01
            tableItems.addCell(new Cell().setBackgroundColor(blue).add(new Paragraph("ITEM").setTextAlignment(TextAlignment.CENTER).setFontSize(6.2f)));
            tableItems.addCell(new Cell().setBackgroundColor(blue).add(new Paragraph("CODIGO").setTextAlignment(TextAlignment.CENTER).setFontSize(6.2f)));
            tableItems.addCell(new Cell().setBackgroundColor(blue).add(new Paragraph("CANT").setTextAlignment(TextAlignment.CENTER).setFontSize(6.2f)));
            ...
            tableItems.addCell(new Cell().setBackgroundColor(blue).add(new Paragraph("SUB TOTAL").setTextAlignment(TextAlignment.CENTER).setFontSize(6.2f)));


            for (int i = 0; i < dataPedidoCabeceraDetalles.size(); i++)
            {
                String itemDetalle = dataPedidoCabeceraDetalles.get(i).getItem().length()>0?dataPedidoCabeceraDetalles.get(i).getItem(): String.valueOf(i + 1);
                tableItems.addCell(new Cell().add(new Paragraph(itemDetalle).setFontSize(6.2f)));
                tableItems.addCell(new Cell().add(new Paragraph(dataPedidoCabeceraDetalles.get(i).getCodpro())).setTextAlignment(TextAlignment.CENTER).setFontSize(6.2f));
                tableItems.addCell(new Cell().add(new Paragraph(String.valueOf(dataPedidoCabeceraDetalles.get(i).getCantidad()))).setTextAlignment(TextAlignment.CENTER).setFontSize(6.2f));
                tableItems.addCell(new Cell().add(new Paragraph(dataPedidoCabeceraDetalles.get(i).getUnidad_medida())).setTextAlignment(TextAlignment.CENTER).setFontSize(6.2f));
                ...
                tableItems.addCell(new Cell().add(new Paragraph(montoDescFormated)).setTextAlignment(TextAlignment.RIGHT).setFontSize(6.2f));
                String precio_neto = FormateadorNumero.formatter3decimal(dataPedidoCabeceraDetalles.get(i).getPrecio_neto());
                tableItems.addCell(new Cell().add(new Paragraph(precio_neto))).setTextAlignment(TextAlignment.RIGHT).setFontSize(6.2f);
            }
        ...
        //TABLE OBSERVACIONES
        tableObservaciones.addCell(new Cell().setBackgroundColor(gray).add(new Paragraph("Observaciones:").setTextAlignment(TextAlignment.CENTER).setBold().setFontSize(6.2f)));
        ...
        //TABLE DATA ----- 01
        tableData.addCell(new Cell().add(new Paragraph(dataCabecera.getObservacion3()).setTextAlignment(TextAlignment.LEFT).setFontSize(6.2f)));
        tableData.addCell(new Cell().add(new Paragraph("IGV").setTextAlignment(TextAlignment.RIGHT).setFontSize(6.2f)));
        tableData.addCell(new Cell().add(new Paragraph(moneda + igvFormateado).setTextAlignment(TextAlignment.RIGHT).setFontSize(6.2f)));

        //TABLE DATA ----- 02
        tableData.addCell(new Cell());
        tableData.addCell(new Cell().add(new Paragraph("TOTAL").setTextAlignment(TextAlignment.RIGHT).setFontSize(6.2f)));
        tableData.addCell(new Cell().add(new Paragraph(moneda + total_netoFormateado).setTextAlignment(TextAlignment.RIGHT).setFontSize(6.2f)));


        //TABLE DATA ----- 03

        //TABLE DATA ----- 04
        tableData.addCell(new Cell().add(new Paragraph(observaciones).setFontSize(6.2f)));
        /***
         * BANCO
         */
