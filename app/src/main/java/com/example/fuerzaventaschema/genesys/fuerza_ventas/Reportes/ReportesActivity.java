...
public class ReportesActivity extends TabActivity {
    ...
    private TabHost.TabSpec search_poi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TabHost.TabSpec transportTab = host.newTabSpec(SEARCH_TRANSPORT).setIndicator(getTabIndicator(R.drawable.icono_liquidacion3_selector, R.string.menu_settings)).setContent(createIntent(LiquidacionActivity.class));
