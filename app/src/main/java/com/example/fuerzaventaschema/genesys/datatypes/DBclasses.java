...
import com.example.fuerzaventaschema.genesys.BEAN.Expectativa;
...
import com.example.fuerzaventaschema.genesys.BEAN.Motivo;
...
import com.example.fuerzaventaschema.genesys.adapters.ModelDevolucionProducto;
import com.example.fuerzaventaschema.genesys.datatypes.DBtables.Banco;
import com.example.fuerzaventaschema.genesys.datatypes.DBtables.Cliente;
import com.example.fuerzaventaschema.genesys.datatypes.DBtables.Cta_ingresos;
import com.example.fuerzaventaschema.genesys.datatypes.DBtables.Ctas_xbanco;
import com.example.fuerzaventaschema.genesys.datatypes.DBtables.Depositos;
import com.example.fuerzaventaschema.genesys.datatypes.DBtables.Direccion_cliente;
import com.example.fuerzaventaschema.genesys.datatypes.DBtables.Familia;
import com.example.fuerzaventaschema.genesys.datatypes.DBtables.Ingresos;
import com.example.fuerzaventaschema.genesys.datatypes.DBtables.MTA_kardex;
import com.example.fuerzaventaschema.genesys.datatypes.DBtables.Motivo_noventa;
import com.example.fuerzaventaschema.genesys.datatypes.DBtables.Pedido_cabecera;
import com.example.fuerzaventaschema.genesys.datatypes.DBtables.Pedido_detalle;
import com.example.fuerzaventaschema.genesys.datatypes.DBtables.Pedido_devolucion;
import com.example.fuerzaventaschema.genesys.datatypes.DBtables.Politica_cliente;
import com.example.fuerzaventaschema.genesys.datatypes.DBtables.Politica_precio2;
import com.example.fuerzaventaschema.genesys.datatypes.DBtables.Politica_vendedor;
import com.example.fuerzaventaschema.genesys.datatypes.DBtables.Producto;
import com.example.fuerzaventaschema.genesys.datatypes.DBtables.Promocion_clientes;
import com.example.fuerzaventaschema.genesys.datatypes.DBtables.Sub_familia;
import com.example.fuerzaventaschema.genesys.datatypes.DBtables.Tb_promocion_detalle;
import com.example.fuerzaventaschema.genesys.datatypes.DBtables.Unidad_medida;
import com.example.fuerzaventaschema.genesys.datatypes.DBtables.Usuarios;
import com.example.fuerzaventaschema.genesys.datatypes.DBtables.Vendedor;
import com.example.fuerzaventaschema.genesys.datatypes.DBtables.ZnfProgramacionClientes;
...
/*
	...
	public ArrayList<HashMap<String, Object>> getProgramacionxDia2() {
		SharedPreferences prefs = _context.getSharedPreferences(
				"MisPreferencias", Context.MODE_PRIVATE);
		String codven = prefs.getString("codven", "por_defecto");
		String rawQuery;
		...
		rawQuery = "select nomcli,ruccli,fecha_compra,monto_compra,cliente.codcli,item_dircli,n_dia,ifnull(observacion,''), " +
				"ifnull((" +
	...
	public void syncClientexVendedor(JSONArray jArray) throws JSONException {
	...
	public void syncDireccionCliente(JSONArray jArray) {

		JSONObject jsonData = null;
		ContentValues cv = new ContentValues();

		getReadableDatabase()
				.delete(DBtables.Direccion_cliente.TAG, null, null);
		SQLiteDatabase db = getWritableDatabase();
	...
	public void syncZnfProgramacionClientes(JSONArray jArray) {

		JSONObject jsonData = null;
		ContentValues cv = new ContentValues();

		getReadableDatabase().delete(DBtables.ZnfProgramacionClientes.TAG,
				null, null);
		SQLiteDatabase db = getWritableDatabase();
	...
	public void syncPoliticaCliente(JSONArray jArray) {
...
Log.e("getPedidosDetalleEntity","Oc_numero: "+cur.getString(0));
	...
	public void sincronizar_lugarEntrega(JSONArray jArray) throws JSONException {
	...
	public void sincronizar_transporte(JSONArray jArray) throws JSONException {
