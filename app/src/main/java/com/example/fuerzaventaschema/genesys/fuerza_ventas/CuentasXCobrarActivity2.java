...
import com.example.fuerzaventaschema.genesys.adapters.Cobranza_LazyAdapter;
                    ...
                    if (Double.parseDouble(saldo) > 0) {
                        ...
                        if (formaPago.equals("COBRAR")){
                            ...
                            if(tipo_de_documento.equals("FACTURA") ){
                                ...
                                AlertDialog.Builder builder = new AlertDialog.Builder( CuentasXCobrarActivity2.this);
