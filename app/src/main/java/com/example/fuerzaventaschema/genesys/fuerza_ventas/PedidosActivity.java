...
import com.example.fuerzaventaschema.genesys.BEAN.model_bonificacion;
...
import com.example.fuerzaventaschema.genesys.DAO.DAO_RegistrosGeneralesMovil;
import com.example.fuerzaventaschema.genesys.adapters.Adapter_Bonificacion_Colores;
import com.example.fuerzaventaschema.genesys.adapters.Adapter_Detalle_Entrega;
import com.example.fuerzaventaschema.genesys.adapters.Adapter_itemPedidoProducto;
...
import com.example.fuerzaventaschema.genesys.datatypes.DBTb_Promocion_Detalle;
import com.example.fuerzaventaschema.genesys.datatypes.DB_Detalle_Entrega;
import com.example.fuerzaventaschema.genesys.datatypes.DB_Pedido_Detalle_Promocion;
import com.example.fuerzaventaschema.genesys.datatypes.DB_PromocionDetalle;
...
import com.example.fuerzaventaschema.genesys.fuerza_ventas.Dialog.DialogFragment_bonificaciones;
import com.example.fuerzaventaschema.genesys.fuerza_ventas.Reportes.ReportesActivity;
import com.example.fuerzaventaschema.genesys.hardware.LocationApiGoogle;
import com.example.fuerzaventaschema.genesys.hardware.Permiso_Adroid;
import com.example.fuerzaventaschema.genesys.hardware.RequestPermisoUbicacion;
import com.example.fuerzaventaschema.genesys.hardware.TaskCheckUbicacion;
...
import com.example.fuerzaventaschema.genesys.util.UtilViewMensaje;
...
public class PedidosActivity extends AppCompatActivity implements View.OnClickListener, DialogFragment_bonificaciones.DialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= 24){
            ...
            ActionItem infoItem_EDITAR_ITEM_PROMO = new ActionItem(EDITAR_ITEM_PROMO, "EDITAR PRODUCTO",R.drawable.icon_man_24dp);
    ...
    public boolean onContextItemSelected(final MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.CntxMenu_Eliminar:
                ...
                ArrayList<DB_RegistroBonificaciones> bonificaciones_xEntrada = DAOBonificaciones.getRegistroBonificaciones_xEntrada(Oc_numero,prod.getCodprod());
    ...
    public void accion_segunId(int acciones, String codPro){
        ...
        switch (acciones) {
            ...
            case EDITAR_ITEM_PROMO:
                ...
                //final ItemProducto bonificacion = (ItemProducto) lstProductos.getAdapter().getItem(info4.position);
                final ItemProducto bonificacion=productos.get(positionLisView);
...
//		dialogo.getWindow().requestFeature(Window.FEATURE_NO_TITLE);
    ...
    public void mostrarListaProductos(String codigoSalida) {
        ...
        for (int i = 0; i < producto.length; i++) {
            ...
            //totalCompleto += total + percepcion;
        ...
        IGV				= GlobalFunctions.redondear_toDouble(IGV);
        ...
        if (cantidadCalculada > 0) {
            ...
            while (it_itemDetallePromocion.hasNext()) {
                ...
                if (itemPromocion.acumulado == 1) { // Si permite acumulado
                     ...
                     */
                    cantidadBonificacion = obtenerCantidadBonificacion(itemPromocion, itemDetalle, Oc_numero);
                }
                ...
                if (cantidadBonificacion > 0) {
                    ...
                    if (DAOBonificaciones
                        ...
                        int cantidad = DAOBonificaciones
                                .obtenerCantidadBonificacion(Oc_numero,
                                        itemPromocion.getSalida());

                        if (cantidad == 0) {
                            // El producto no tiene cantidad, no debe ser
                            // mostrado
                            DAOPedidoDetalle.Eliminar_itemPedidoBonificacion(
                                    itemPromocion.getSalida(), Oc_numero);
                        } else {
    ...
    private int RegistroBonificacion(String oc_numero,
        ...
        if (listaEntradasCompuestasAux.size() > 0) {
            ...
            for (int i = 0; i < listaEntradasCompuestasAux.size(); i++) {
                ...
                DAOBonificaciones.Eliminar_RegistroBonificacion(oc_numero,
        ...
        int cantidadEntregada = DAOBonificaciones.getCantidadEntregada(oc_numero,"B"+promocionDetalle.getSalida());
        int cantidad = DAOBonificaciones.obtenerCantidadBonificacion(oc_numero,"B"+promocionDetalle.getSalida());
    ...
    public void onItemClick(int posicion,
        ...
        if (accionGlobal.equals("editar")) {
            ...
            ArrayList<DB_RegistroBonificaciones> bonificaciones_xEntrada = DAOBonificaciones
                    .getRegistroBonificaciones_xEntrada(Oc_numero,
                            listaPromociones.get(0).getEntrada());
        ...
        cantidadActualizada = RegistroBonificacion(Oc_numero, promocionDetalle,
                ...
                cantidadesUsadas, montosUsados);

        DBPedido_Detalle dbdetalle_temporal = dbclass.existePedidoDetalle2(
                Oc_numero, "B"+promocionDetalle.getSalida(), dbclass.obtener_codunimedXtipo_unimed_salida(Integer
                        .parseInt(promocionDetalle.getTipo_unimed_salida()),promocionDetalle.getSalida()));
