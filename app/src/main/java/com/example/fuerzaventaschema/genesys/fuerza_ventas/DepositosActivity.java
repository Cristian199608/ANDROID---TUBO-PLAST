...
import com.example.fuerzaventaschema.genesys.datatypes.DBBanco;
import com.example.fuerzaventaschema.genesys.datatypes.DBCtas_xbanco;
import com.example.fuerzaventaschema.genesys.datatypes.DBDepositos;
...
public class DepositosActivity extends AppCompatActivity  implements OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (sincronizacionCorrecta == false) {
            AlertDialog.Builder alerta = new AlertDialog.Builder(DepositosActivity.this);
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            case R.id.depositos_btnAgregar:
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(DepositosActivity.this);
    ...
    private void crear_dialogo_post_envio(String titulo, String mensaje, int icon){
        ...
        Builder dialogo2 = new AlertDialog.Builder(DepositosActivity.this);
