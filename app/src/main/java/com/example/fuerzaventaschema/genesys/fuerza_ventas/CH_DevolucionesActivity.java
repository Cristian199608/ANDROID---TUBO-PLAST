...
import com.example.fuerzaventaschema.genesys.adapters.CH_Adapter_itemDevolucionProducto;
...
//		dialogo.getWindow().requestFeature(Window.FEATURE_NO_TITLE);
    ...
    public java.math.BigDecimal redondear(double val) {
        String r = val + "";
        java.math.BigDecimal big = new BigDecimal(r);
