package com.example.fuerzaventaschema.genesys.fuerza_ventas.Google;
...
import com.example.fuerzaventaschema.genesys.adapters.AdapterCLientesMap;
    ...
    public void onRequestPermissionsResult( int requestCode, String permissions[], int[] grantResults) {
        if (requestCode==PERMISO_PARA_ACCEDER_A_LOCALIZACION){
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(this, "Oermuso aceptado", Toast.LENGTH_SHORT).show();
                Pre_StartUbicacionApiGoogle();
            } else {
