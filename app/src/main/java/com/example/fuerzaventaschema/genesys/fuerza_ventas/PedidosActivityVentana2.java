...
import com.example.fuerzaventaschema.genesys.adapters.PedidoAdapter;
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.CntxMenu_Eliminar_item_promo:
                ...
                //dbclass.EliminarItemPedido(prod3.getCodprod(), Oc_numero);

                dbclass.marcar_item_promo_como_eliminado(prod3.getCodprod(), Oc_numero);

                //dbclass.actualizar_stock_xtemp(0, prod3.getCodprod());
            ...
            case R.id.CntxMenu_Editar:
                ...
                final ItemProducto prod2 = (ItemProducto) lstProductos.getAdapter().getItem(info2.position);
                Intent intent = new Intent(PedidosActivityVentana2.this, ProductoActivity.class);
                ...
                intent.putExtra("CODPRO", prod2.getCodprod());
                //intent.putExtra("CODUNIMED",prod2.get)
                ...
                Log.d("PedidosActivityVentana2 ::item Editar::", "Envio a ProductoActivity :PEDIDO_MODIFICAR:");

                startActivityForResult(intent, 1);

                final Dialog dialog_cant = new Dialog(this);
                dialog_cant.requestWindowFeature(Window.FEATURE_NO_TITLE);
                dialog_cant.setContentView(R.layout.dialog_cant_lyt);
                Button btnAceptar = (Button) dialog_cant.findViewById(R.id.dialog_cant_lyt_btnAceptar);
                Button btnCancelar = (Button) dialog_cant.findViewById(R.id.dialog_cant_lyt_btnCancelar);
                final EditText edtCantidad = (EditText) dialog_cant.findViewById(R.id.dialog_cant_lyt_edtCantidad);
                ...
                btnAceptar.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (edtCantidad.getText().toString().length() != 0) {
                            ...
                            double precio = Math.round((prod2.getSubtotal() / prod2.getCantidad()) * 100) / 100.0;
                            double peso = Math.round((prod2.getPeso() / prod2.getCantidad()) * 100) / 100.0;

                            dbclass.modificarItempedido(cant, peso, precio, prod2.getCodprod().toString(), Oc_numero);

                            dbclass.actualizar_stock_xtemp(cant * prod2.getFact_conv(), prod2.getCodprod());
